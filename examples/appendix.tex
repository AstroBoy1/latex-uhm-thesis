...
\begin{figure}[!htb]
        ...
        \centering
        \includegraphics[width=0.2\textwidth]{images/cc_best_mesh_1.png}
\end{figure}
\begin{figure}[!htb]
...
\begin{figure}[!htb]
        ...
        \centering
        \includegraphics[width=0.2\textwidth]{images/cc_best_mesh_3.png}
\end{figure}

\begin{figure}[!htb]
        \caption{Connected Components Worst  Mesh 3}
        \centering
        \includegraphics[width=0.2\textwidth]{images/cc_worst_mesh_4.png}
\end{figure}

\begin{figure}[!htb]
        \caption{Connected Components Worst  Mesh 2}
        \centering
        \includegraphics[width=0.2\textwidth]{images/cc_worst_mesh_5.png}
\end{figure}
...
\begin{figure}[!htb]
        ...
        \centering
        \includegraphics[width=0.2\textwidth]{images/labeled_mesh.png}
\end{figure}

\begin{figure}[!htb]
        \caption{Ideal mesh reposed through Meshcapade}
        \centering
        \includegraphics[width=0.4\textwidth]{images/reposed_mesh.png}
\end{figure}

\begin{figure}[!htb]
        \caption{Turntable speed}
        \centering
        \includegraphics[width=0.7\textwidth]{images/turntable_speed.png}
\end{figure}
