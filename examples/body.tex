...
\begin{figure}[!htb]
	...
	\centering
	\includegraphics[width=0.4\textwidth]{images/fit3d.jpg}
\end{figure}
\begin{figure}[!htb]
	\caption{Naked Labs Scanner}
	\centering
	\includegraphics[width=0.4\textwidth]{images/naked_labs.jpg}
\end{figure}
\begin{figure}[!htb]
	\caption{Styku Scanner}
	\centering
	\includegraphics[width=0.4\textwidth]{images/styku.jpg}
\end{figure}
\section{3d Optical Scanners}
\begin{figure}[!htb]
	\caption{Sizestream Scanner}
	\centering
	\includegraphics[width=0.4\textwidth]{images/sizestream.jpg}
\end{figure}
...
Several papers have done sensor testing with depth cameras. Overall methodology was studied in these papers \cite{sophian2017evaluation} \cite{khoshelham2012accuracy} \cite{langmann2012depth} \cite{sankowski2017estimation}.
...
\begin{figure}[!htb]
	...
	\centering
	\includegraphics[width=0.5\textwidth]{images/labels_classification_front.png}
\end{figure}
...
\begin{figure}[!htb]
	...
	\centering
	\includegraphics[width=0.5\textwidth]{images/prediction_classification_front.png}
\end{figure}
...
\begin{figure}[!htb]
	...
	\centering
	\includegraphics[width=0.1\textwidth]{images/90fps_mannequin.png}
\end{figure}
...
\begin{figure}[!htb]
	...
	\centering
	\includegraphics[width=0.4\textwidth]{images/framing.png}
\end{figure}
...
I did a comparison of various 3d imaging sensors. I found that the closer the sensor to the object, the less spatial noise; however there is a certain minimum distance for each sensor that it can image.So in general one wants to get the sensor as close as possible beyond this minimum distance. This isi especially true with 3d reconstruction which having the sensors as close as possible to the target really helps with the mesh quality which helps models obtain body composition from the data. The D435 had the lowest error when using a stationary target. The temporal noise for the sensors were all extremely low. Fill rate had interesting results with the Kinect 360 having the highest fill rate. While the azure kinect had the lowest fill rate. One can clearly see the poor fill rate when looking at the depth image of the azure kinect. It would seem like one of the reasons they did this was to boost the accuracy of the sensor on pixels it was sure of. While the previous kinects have these edge problems, they still reported a value regardless of its accuracy. The D415 has much worse fill rate compared to the D435, although the amount of noise is less, this noise is very minimal and not a problem in the reconstruction process.
