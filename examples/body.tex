...
A few methods were tried out such as recent deep learning methods \cite{kolotouros2019learning}. Also the classic kinect fusion code was tried out \cite{izadi2011kinectfusion}. Finally a high level library of the kinect fusion code was used.
...
\section{Mesh similarity for ranking mesh quality}
